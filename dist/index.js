    ...
    try {
        ...
        program
            ...
            if (projectName) {
                ...
                console.log(chalk_1.default.gray('  $ create-mono-app my-app'));
                console.log(chalk_1.default.gray('  $ mono-cli my-app'));
                console.log(chalk_1.default.gray('  $ cd my-app'));
                console.log(chalk_1.default.gray('  $ pnpm dev'));
                console.log();
                console.log(chalk_1.default.cyan('🔗 更多信息:'));
                console.log(chalk_1.default.gray('  文档: https://github.com/KangLeon/mono-full-stack-cli'));
                console.log();
            }
        });
        program
